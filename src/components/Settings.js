...
class Settings extends Component {
    ...
    render() {
        if (this.props.showAdvancedSettings){
            ...
            const markdownMarks = {0:"Purist",1:"Extended",2:"Spiced up",3:"Plugin addict"}

            const settings = this.props.settings.mdSettings
            const isExtended = settings.katex && settings.breaks && settings.anchor && settings.typographer
            ...
            const mdModes = {
                0: {
                    typographer: false, breaks: false, checkbox: false, anchor: false,
                    toc:false, katex:false, smartarrows:false, alert: false,
                    note: false, spoiler: false, url: false, video: false, graph: false,
                },
                1: {
                    typographer: true, breaks: true, checkbox: false, anchor: true,
                    toc:false, katex:true, smartarrows:false, alert: false,
                    note: false, spoiler: false, url: false, video: false, graph: false,
                },
                2: {
                    typographer: true, breaks: true, checkbox: false, anchor: true,
                    toc:true, katex:true, smartarrows:true, alert: false,
                    note: false, spoiler: false, url: true, video: true, graph: false,
                },
                3: {
                    typographer: true, breaks: true, checkbox: true, anchor: true,
                    toc:true, katex:true, smartarrows:true, alert: true,
                    note: true, spoiler: true, url: true, video: true, graph: true,
                }
            }
            ...
            >
                ...
                <Slider marks={interfaceMarks} step={null} value={1} min={0} max={2} tipFormatter={id => interfaceMarks[id]}/>
                Markdown extensions
                <Slider marks={markdownMarks} step={null} value={markdownLevel} min={0} max={3} tipFormatter={id => markdownMarks[id]} onChange={markdownChange}/>
                <Button onClick={this.props.toggleAdvancedSettings}>
